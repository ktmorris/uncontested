...
# 
# mout <- Matchby(Tr = ga$uncontested, X = X, by = c(X$dem, X$rep, X$gender), estimand = "ATT", Weight.matrix = genout, M = 100)
# 
...
# m1 <- left_join(m1, ga, by = "voter_id")
# 
# saveRDS(m1, "./temp/ga_reg_data.rds")

m1 <- readRDS("./temp/ga_reg_data.rds")
...
reg <- inner_join(ga, matches, by = "voter_id")
...
save(reg1, reg2, c1, c2, file = paste0("./temp/ga_match_reg.rdata"))
...
save(reg1, reg2, c1, c2, file = paste0("./temp/ga_white_match_reg.rdata"))
...
save(reg1, reg2, c1, c2, file = paste0("./temp/ga_black_match_reg.rdata"))
...
save(reg1, reg2, c1, c2, file = paste0("./temp/ga_latinx_match_reg.rdata"))

####### dem

m2 <- filter(m1, (dem == T & cd == "1305") |
               (rep == T & cd == "1308")) ## filter observations based on characteristics of treated voter
...
save(reg1, reg2, c1, c2, file = paste0("./temp/ga_dem_match_reg.rdata"))

####### rep

m2 <- filter(m1, (rep == T & cd == "1305") |
               (dem == T & cd == "1308")) ## filter observations based on characteristics of treated voter
...
save(reg1, reg2, c1, c2, file = paste0("./temp/ga_rep_match_reg.rdata"))
...
save(reg1, reg2, c1, c2, file = paste0("./temp/ga_lt_40_match_reg.rdata"))
...
save(reg1, reg2, c1, c2, file = paste0("./temp/ga_40_65_match_reg.rdata"))
...
save(reg1, reg2, c1, c2, file = paste0("./temp/ga_gt65_match_reg.rdata"))
...
save(reg1, reg2, c1, c2, file = paste0("./temp/ga_men_match_reg.rdata"))
...
save(reg1, reg2, c1, c2, file = paste0("./temp/ga_women_match_reg.rdata"))